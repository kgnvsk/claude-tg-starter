...
- Реліз: `2026-09-16.4477ab50e425`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `4477ab50e42576912d65a76685010723f15cbae1`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    нагадування: повтор без дрейфу, «щодня» в персоні — завжди repeat (#68)
