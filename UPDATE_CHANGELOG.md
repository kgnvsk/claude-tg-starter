...
- Реліз: `2026-09-23.2aaa8bf3ba36`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `2aaa8bf3ba36e07451948809be998be2ff75fba9`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    Codex: програма-посередник не зупиняє агента запитами дозволу
    Codex: агент і його помічники працюють без запитів дозволу, з мережею і записом у свій дім
