...
- Реліз: `2026-09-23.a94284836293`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `a942848362931350d3bc5c968008ba42cc3d457e`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    Тести: перевірка корпоративної паузи чекає на базу замість миттєвого падіння
    Помічники агента працюють з повним доступом і не просять дозволу
