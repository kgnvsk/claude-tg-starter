...
- Реліз: `2026-09-21.1abdf0eabb82`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `1abdf0eabb8279fafc5dc30c7be1f7014ada5978`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    Тест: голосове повідомлення власника перевіряється поряд із блоком фото
    SEC EDGAR: кирилична назва компанії в налаштуваннях більше не ламає запити
    Тести корпоративного модуля не залежать від швидкості машини
    telegram: фото, надіслане в групу без згадки, доходить до агента разом зі згадкою, що йде слідом
