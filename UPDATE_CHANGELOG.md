...
- Реліз: `2026-09-22.07fbc6c6bbf3`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `07fbc6c6bbf3da0ac09643d869a155f687f75fd4`
- Дата релізу: `2026-09-22`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    Модель з налаштувань діє й тоді, коли бот продовжує розмову
    Нові агенти працюють на Claude Opus 5.5
    fix: Google commands accept --account when it names the connected account
    fix: a failed scheduled task tells the owner the cause in plain words
