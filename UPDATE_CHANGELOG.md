...
- Реліз: `2026-09-13.074a96b4ced5`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `074a96b4ced5bbb80bf3122ac2061e9993791c42`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    fix(backup): preserve durable data and avoid false credential sources
