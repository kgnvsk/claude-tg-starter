...
- Реліз: `2026-09-23.e419629a9de0`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `e419629a9de0a92524802916fcdfb81d0c15f1ce`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    Telegram: відповідь після фонової задачі знімає повідомлення з черги, а сторож стану попереджає, якщо черга все одно стоїть
    Telegram: відповідь не застрягає в черзі через нові службові нагадування Claude Code 2.1.280
    Сторож лімітів не замовкає, коли стара історія видалена
