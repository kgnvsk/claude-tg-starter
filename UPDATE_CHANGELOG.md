...
- Реліз: `2026-09-10.17b2b6e27fd5`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `17b2b6e27fd512cece894b25e42b236f8d24cd3b`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    fix: Preserve Telegram delivery across native task notifications
