...
- Реліз: `2026-09-06.7b2ee7576258`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `7b2ee757625859758e82dded46f97aede51fd682`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    fix(agents): complete owner approvals and preserve delegation order
