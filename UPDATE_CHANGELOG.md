...
- Реліз: `2026-09-09.c9803b088655`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `c9803b0886554cf741b7d3099aab04b559605422`
- Дата релізу: `2026-09-09`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    fix: Retain delivered work and recall only current verified solutions
