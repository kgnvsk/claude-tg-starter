...
- Реліз: `2026-09-23.ea8c78e6ac14`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `ea8c78e6ac14431a5b5c5bbfdfa18a2363c121d2`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    Перевірка тайм-ауту git у завантажувачі навичок більше не падає, коли машина зайнята
    Резервна копія на GitHub працює зі сховищем на гілці master, а неналаштована копія так і називається
    Автозадача відповідає мовою, якою написане завдання
    Помічники бота користуються конекторами (Notion, Google Drive тощо) і пошуком інструментів
    Сторож не вимагає знову «працюю», коли помічник продовжує роботу, фонових задач кілька або задачу зупинено
    Тихі автозадачі: завдання з QUIET=1 саме надсилає звіт у теми групи, а його текст більше не потрапляє в загальний чат
    Тест відновлення браузера: вікно очікування не залежить від навантаження
