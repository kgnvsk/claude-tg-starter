...
- Реліз: `2026-09-16.1a506af77ba1`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `1a506af77ba1440b43f11849c70c647456be4f3d`
- Дата релізу: `2026-09-16`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    черга як годинник: добійник повертає повідомлення, лічильник рестартів 24.04/26.04, api-error-turns, платні кити локально для Codex (#67)
    healthcheck: мертвий сторож лімітів більше не мовчить тижнями (#65)
    backup: повний бекап більше не падає на Python 3.12 і на середовищах кіта (#66)
