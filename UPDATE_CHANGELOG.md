...
- Реліз: `2026-09-23.c4fa5a862f27`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `c4fa5a862f27ef5d2463e198d9ab500d547a40fe`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    Суперадміністратор: без bypassPermissions — --restricted його не приймає
    Суперадміністратор: бізнес-асистент власника з його правами, без його особистого листування
