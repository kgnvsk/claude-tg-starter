...
- Реліз: `2026-09-10.f76f6dbccf8d`
- Продукт: `starter` — Novsky Starter
- Ревізія вихідного комплекту: `f76f6dbccf8d53d86ab7d28d657e0b470936deac`
- Дата релізу: `2026-09-10`
...
продуктів; точний склад цього пакета наведено нижче.
    ...
    fix: Keep passive group observations silent without dropping work
